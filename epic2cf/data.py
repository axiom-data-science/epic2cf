...
epic_map = {
    ...
    310  : dict(standard_name='sea_water_to_direction', long_name='Current direction (to)', units='degree', convert=lambda x: x, cf_units='degree', cell_methods=None),  # CD :CURRENT DIRECTION (T)     :vdir:degrees:f8.2:oceanographic (going to, using true north,
    ...
    4064 : dict(standard_name='sea_surface_wave_maximum_height', long_name='Maximum Wave Height', units='m', convert=lambda x: x, cf_units='m', cell_methods=None),  # mwh :Maximum Wave Height      :wave_height:m:f10.2:,
